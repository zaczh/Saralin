//
//  DatabaseMetaViewController.swift
//  Saralin
//
...
class DatabaseMetaViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let detail = DatabaseRecordsViewController(fetchRequest: request)
